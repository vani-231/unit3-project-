...
function add3(){
          ...
          ma2.textContent = "A. If your order was shipped by Express Post then you can track your order through"
...
track.onclick = () =>{
    if(inp.value.length ===0){
        ...
        let d = new Date()
        ma2.textContent = "Order Date : " + d.getDate() + "/" + (d.getMonth()+1) + "/" + d.getFullYear()
        ma3.textContent  = "Date : " + d.getDate() + "/" + (d.getMonth()+1) + "/" + d.getFullYear()+" " + d.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })
